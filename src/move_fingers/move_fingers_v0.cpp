...
int main(int argc, char* argv[])
{
  ...
  // // Write goal position
  // dxl_comm_result = packetHandler->write4ByteTxRx(portHandler, DXL1_ID, ADDR_PRO_GOAL_POSITION, dxl_goal_position[index], &dxl_error);
  // if (dxl_comm_result != COMM_SUCCESS)
  // {
  //   packetHandler->printTxRxResult(dxl_comm_result);
  // }
  ...
  // }
  //   // Write goal position
  // dxl_comm_result = packetHandler->write4ByteTxRx(portHandler, DXL2_ID, ADDR_PRO_GOAL_POSITION, dxl_goal_position[index], &dxl_error);
  // if (dxl_comm_result != COMM_SUCCESS)
  // {
  //   packetHandler->printTxRxResult(dxl_comm_result);
  // }
